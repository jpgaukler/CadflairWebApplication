...
{
    [Guid("36a1d82b-0a25-4e34-b527-9966b7f6e966")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": SiloAutomationPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");

            // Initialize AddIn members.
            _inventorServer = addInSiteObject.InventorServer;
            Automation = new SiloAutomation(_inventorServer);
        }

        public void Deactivate()
        {
            Trace.TraceInformation(": SiloAutomationPlugin: deactivating... ");
