import { Container, Title, Text, List, Group, Button, Image, ThemeIcon, rem, Stack, Paper, TextInput, Textarea } from "@mantine/core";
import classes from './Home.module.css';
import logo from '../assets/cadflair_logo.svg';
import heroImg from '../assets/product_mockup.png';
import { IconArrowBarUp, IconArrowDown, IconCheck, IconCircleCheck, IconEdit, IconShare } from "@tabler/icons-react";
...
export default function Home() {
    ...
    return (
        <>
            <Container size="lg">
                <Group wrap="nowrap" justify="space-between" my="lg">
                    <div>
                ...
                <Stack w="100%" align="center">
                    ...
                    <IconArrowDown size={24} stroke={1} />
                </Stack>
            </Container>
            ...
            <div className={ classes.content }>
                <Container size="lg">
                    <Group wrap="nowrap">
                        <div>
                            <Group align="center">
                                <Title order={2}>What is</Title>
                                <Image src={logo} alt="Cadflair Logo" h={50} />
                                <Title order={2}>?</Title>
                            </Group>
                            <Text>
                        ...
                        <div>
                            ...
                            <List
                                spacing="lg"
                                icon={
                                    <ThemeIcon color="cadFlairBlue" size={36} radius="xl">
                                        <IconCircleCheck style={{ width: rem(36), height: rem(36), strokeWidth: 1 }} />
                                    </ThemeIcon>
                                }>
                                <List.Item>
                    ...
                    <Group wrap="nowrap" grow>
                        <Paper withBorder mih="415px" p="md">
                            <Stack h="100%">
                    ...
                    <Paper shadow="md" p="md" style={{ marginTop: "100px", marginBottom: "100px" }}>
                        <Stack align="center">
