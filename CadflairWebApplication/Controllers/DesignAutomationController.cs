...
namespace Forge.Controllers
{
    ...
    public class DesignAutomationController : ControllerBase
    {
        ...
        public async Task<IActionResult> TranslationFinished([FromBody] dynamic body)
        {
            try
            {
        ...
        public async Task<IActionResult> CreateDresserModel_OnCallback(string id, string outputBucketKey, string outputIamName, string rootFileName, string outputPdfName, [FromBody] dynamic body)
        {
            try
            {
                ...
                dynamic signedIamUrl = await objectsApi.CreateSignedResourceAsyncWithHttpInfo(outputBucketKey, outputIamName, new PostBucketsSigned(10), "read");
