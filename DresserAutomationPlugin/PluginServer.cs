...
{
    [Guid("3d1a41c1-fbb3-45ff-a943-61de5d300286")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": DresserAutomationPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");

            // Initialize AddIn members.
            _inventorServer = addInSiteObject.InventorServer;
            Automation = new DresserAutomation(_inventorServer);
        }

        public void Deactivate()
        {
            Trace.TraceInformation(": DresserAutomationPlugin: deactivating... ");
