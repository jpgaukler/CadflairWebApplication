...
{
    public class DriveDocument : IComparable<DriveDocument>
    {
        /// <summary>
        /// Primary key.
        /// </summary>
        ...
        /// <summary>
        /// Foreign key to <b>DriveFolder</b> table. Represents the DriveFolder that the Product belongs to.
        /// </summary>
        ...
        public int CompareTo(DriveDocument other)
        {
